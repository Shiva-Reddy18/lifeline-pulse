...
export function SystemActivity() {
  ...
  const flagRequest = async (id: string) => {
    ...
    if (!error) {
      ...
      queryClient.invalidateQueries({ queryKey: ["admin-system-activity"] });
  ...
  return (
    <Card className="bg-white/70 backdrop-blur-xl border border-white/50 shadow-xl shadow-black/5">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
                  <p>
                    ...
                    {req.patient_phone ?? "Not provided"}
                  </p>
                  <p>
                    🏥 <span className="font-medium">Hospital:</span>{" "}
                    {req.hospital_name ?? "Not specified"}
                  </p>
